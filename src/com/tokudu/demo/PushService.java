...
public class PushService extends Service
{
	...
	private static final String		MQTT_HOST = "192.168.1.222";
	...
	public static String			MQTT_CLIENT_ID = "summa_android";
	...
	// Notification title
	public static String			NOTIF_TITLE = "Summa"; 	
	// Notification id
	...
	private synchronized void connect() {		
		...
		if (deviceID == null) {
			...
			log("Device: " + deviceID);
			try {
				mConnection = new MQTTConnection(MQTT_HOST, "MOBILE");
